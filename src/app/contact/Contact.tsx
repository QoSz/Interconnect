...
export default function Contact() {
    ...
    return (
        <main className="relative min-h-[80vh] text-slate-900 dark:text-gray-100">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-white via-slate-50 to-sky-100 dark:from-transparent dark:via-purple-900/15 dark:to-transparent pointer-events-none" />
            ...
            <section className="relative pt-8 sm:pt-12 md:pt-16 pb-8 sm:pb-10 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto text-center">
                    <h1 className="text-3xl md:text-4xl font-bold text-sky-700 dark:text-purple-200 mb-3 sm:mb-4">
                        Get in touch with{' '}
                        <span className="bg-gradient-to-r from-sky-500 to-blue-500 dark:from-purple-500 dark:to-indigo-500 bg-clip-text text-transparent">Interconnect</span>
                    </h1>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
                        ...
                        <div className="md:col-span-1 lg:col-span-1 space-y-4 sm:space-y-6">
                            {/* Email */}
                            <div className="bg-white/80 dark:bg-gray-800/50 backdrop-blur-md rounded-2xl p-4 sm:p-6 shadow-xl shadow-sky-200/40 dark:shadow-purple-900/30 border border-sky-200/50 dark:border-purple-500/20">
                                <div className="flex items-center">
                                    <div className="p-2 sm:p-3 rounded-xl bg-gradient-to-br from-sky-200/40 to-blue-200/40 dark:from-purple-600/10 dark:to-indigo-600/10 flex-shrink-0">
                                        <Mail className="h-5 w-5 sm:h-6 sm:w-6 text-sky-600 dark:text-purple-400" />
                                    </div>
                                    <div className="ml-3 sm:ml-4 min-w-0">
                                        <h3 className="text-lg sm:text-xl font-bold text-sky-700 dark:text-purple-200 mb-1 sm:mb-1.5">Email</h3>
                            ...
                            <div className="bg-white/80 dark:bg-gray-800/50 backdrop-blur-md rounded-2xl p-4 sm:p-6 shadow-xl shadow-sky-200/40 dark:shadow-purple-900/30 border border-sky-200/50 dark:border-purple-500/20">
                                <div className="flex items-center">
                                    <div className="p-2 sm:p-3 rounded-xl bg-gradient-to-br from-sky-200/40 to-blue-200/40 dark:from-purple-600/10 dark:to-indigo-600/10 flex-shrink-0">
                                        <Phone className="h-5 w-5 sm:h-6 sm:w-6 text-sky-600 dark:text-purple-400" />
                                    </div>
                                    <div className="ml-3 sm:ml-4 min-w-0">
                                        <h3 className="text-lg sm:text-xl font-bold text-sky-700 dark:text-purple-200 mb-1 sm:mb-1.5">Phone</h3>
                            ...
                            <div className="bg-white/80 dark:bg-gray-800/50 backdrop-blur-md rounded-2xl p-4 sm:p-6 shadow-xl shadow-sky-200/40 dark:shadow-purple-900/30 border border-sky-200/50 dark:border-purple-500/20">
                                <div className="flex items-start">
                                    <div className="p-2 sm:p-3 rounded-xl bg-gradient-to-br from-sky-200/40 to-blue-200/40 dark:from-purple-600/10 dark:to-indigo-600/10 flex-shrink-0">
                                        <MapPin className="h-5 w-5 sm:h-6 sm:w-6 text-sky-600 dark:text-purple-400" />
                                    </div>
                                    <div className="ml-3 sm:ml-4 min-w-0">
                                        <h3 className="text-lg sm:text-xl font-bold text-sky-700 dark:text-purple-200 mb-1 sm:mb-1.5">Address</h3>
                        ...
                        <div className="md:col-span-1 lg:col-span-2">
                            <div className="bg-white/80 dark:bg-gray-800/50 backdrop-blur-md rounded-2xl p-6 sm:p-8 shadow-xl shadow-sky-200/40 dark:shadow-purple-900/30 border border-sky-200/50 dark:border-purple-500/20">
                                <h2 className="text-xl sm:text-2xl font-bold text-sky-700 dark:text-purple-200 mb-4 sm:mb-6">Send us a message</h2>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                name="firstName"
                                                required
                                                className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-white/80 dark:bg-transparent border border-slate-200/70 dark:border-gray-600/60 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-sky-300 dark:focus:ring-purple-500 dark:focus:border-transparent transition-all duration-300 placeholder:text-slate-400 dark:placeholder:text-gray-500 text-slate-900 dark:text-gray-100"
                                    ...
                                    <div>
                                        <Button
                                            ...
                                            className="w-full bg-gradient-to-r from-sky-500 to-blue-500 dark:from-purple-600 dark:to-indigo-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl text-base sm:text-lg font-semibold transition-all duration-300 hover:brightness-110 hover:scale-[1.02] shadow-lg shadow-sky-200/60 dark:shadow-indigo-500/25 hover:shadow-sky-300/80 dark:hover:shadow-indigo-400/40 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                                        >
                                            {isSubmitting ? (
                                                <>
